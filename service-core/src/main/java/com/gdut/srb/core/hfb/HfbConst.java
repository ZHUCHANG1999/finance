...
public class HfbConst {
    ...
    //用户绑定异步回调
    public static final String USERBIND_NOTIFY_URL = "http://localhost:8110/api/core/userBind/notify";
    //用户绑定同步回调
    ...
    //充值异步回调
    public static final String RECHARGE_NOTIFY_URL = "http://localhost:8110/api/core/userAccount/notify";
    //充值同步回调
    ...
    //充值异步回调
    public static final String INVEST_NOTIFY_URL = "http://localhost:8110/api/core/lendItem/notify";
    //充值同步回调
    ...
    //充值异步回调
    public static final String WITHDRAW_NOTIFY_URL = "http://localhost:8110/api/core/userAccount/notifyWithdraw";
    //充值同步回调
    ...
    //充值异步回调
    public static final String BORROW_RETURN_NOTIFY_URL = "http://localhost:8110/api/core/lendReturn/notifyUrl";
    //充值同步回调
